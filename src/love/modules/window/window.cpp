...
int getMode(lua_State* L){
  ...
  printf("Pushing the width and height\n");
  ...
  //lua_State* L = LState;
  lua_newtable(L);
  printf("Setting field : width\n");
  lua_pushstring(L, "width");
  lua_pushnumber(L, 600);
  lua_settable(L, -3);
  printf("Setting field : height\n");
  lua_pushstring(L, "height");
  lua_pushnumber(L, 480);
  lua_settable(L, -3);
  printf("Setting field : fullscreen\n");
  lua_pushstring(L, "fullscreen");
  lua_pushboolean(L, false);
  lua_settable(L, -3);
  printf("Setting field : vsync\n");
  lua_pushstring(L, "vsync");
  lua_pushboolean(L, true);
  lua_settable(L, -3);
  printf("Setting field : msaa\n"); 
  lua_pushstring(L, "msaa");
  lua_pushnumber(L, 0);
  lua_settable(L, -3);
  printf("Setting field : display\n");
  lua_pushstring(L, "display");
  lua_pushnumber(L, 1);
  lua_settable(L, -3);
  printf("Setting field : resizable\n");
  lua_pushstring(L, "resizable");
  lua_pushboolean(L, false);
  lua_settable(L, -3);
  printf("Setting field : borderless\n");
  lua_pushstring(L, "borderless");
  lua_pushboolean(L, false);
  lua_settable(L, -3);
  printf("Setting field : minheight\n");
  lua_pushstring(L, "minwidth");
  lua_pushnumber(L, 600);
  lua_settable(L, -3);
  printf("Setting field : minwidth\n");
